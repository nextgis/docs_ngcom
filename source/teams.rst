...
Пользователи, находящиеся на плане Free, не могут создать свою команду, но могут быть `добавлены <https://docs.nextgis.ru/docs_ngcom/source/teams.html#ngcom-team-management>`_ в качестве участников в команду пользователя плана `Premium <http://nextgis.ru/nextgis-com/plans>`_.
