...
По умолчанию в команде уже находится владелец Веб ГИС, который приобрел подписку на Premium (см. :numref:`First_administrator`). Он имеет возможность добавить новых пользователей, нажав кнопку **“Добавить”** и найдя их по имени NextGIS ID (см. :numref:`list_users`). Пользователи должны быть уже зарегистрированы на my.nextgis.com. Имя пользователя можно увидеть в его профиле на https://my.nextgis.com/. У пользователя в команде будет значится план Free - это нормально, он будет иметь возможность пользоваться Premium-функциями программного обеспечения.
