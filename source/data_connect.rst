...
#. Откройте `Группу ресурсов <https://docs.nextgis.ru/docs_ngweb/source/create_resource.html#ngw-resource-group>`_, в которой вы хотите создать подложку (на главной странице Веб ГИС по умолчанию открыта Основная группа ресурсов);
...
.. note:: 
	Рекомендуем сразу создать отдельную `Группу ресурсов <https://docs.nextgis.ru/docs_ngweb/source/create_resource.html#ngw-resource-group>`_ "Подложки" или "Базовые карты" для хранения подложек, которые вы планируете подключать на свои :ref:`Веб-карты <ngcom_webmap_create>`.
...
#. Откройте `Группу ресурсов <https://docs.nextgis.ru/docs_ngweb/source/create_resource.html#ngw-resource-group>`_, в которой вы хотите создать соединение (на главной странице Веб ГИС по умолчанию открыта Основная группа ресурсов);
...
#. Откройте `Группу ресурсов <https://docs.nextgis.ru/docs_ngweb/source/create_resource.html#ngw-resource-group>`_, в которой вы хотите создать cоединение (на главной странице Веб ГИС по умолчанию открыта Основная группа ресурсов);
