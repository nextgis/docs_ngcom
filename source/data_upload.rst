...
.. admonition:: Где взять данные?
   ...
   Получить геоданные на любое место Земли на `NextGIS Data <https://data.nextgis.com/ru/>`_.
...
На Free вы можете создать до 15 слоёв. Чтобы снять это ограничение, вы можете `оформить подписку Premium <https://nextgis.ru/pricing-base/>`_.
