...
3. Данные во внешней БД должны действительно быть в указанной системе координат, т.е. описание СК должно соответствовать данным.
...
в Веб ГИС будут перепроецированы "на лету" и корректно отображаться совместно с любыми другими данными в вашей Веб ГИС.
