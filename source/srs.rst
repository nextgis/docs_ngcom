...
.. note::
    Функциональность по поддержке пользовательских систем координат доступна на планах `Премиум <https://nextgis.ru/pricing-base/>`_ и `Корпоративный <http://nextgis.ru/pricing/#corporate/>`_
