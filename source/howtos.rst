...
*  `Как подключить мониторинг движущихся объектов (трекинг) <https://docs.nextgis.ru/docs_ngcom/source/tracking.html>`_
* `Как начать сбор данных в вашей Веб ГИС <https://docs.nextgis.ru/docs_ngcom/source/collector.html>`_
