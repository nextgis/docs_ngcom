...
#. Откройте `Группу ресурсов <https://docs.nextgis.ru/docs_ngweb/source/create_resource.html#ngw-resourses-group>`_, в которой вы хотите создать сервис (на главной странице Веб ГИС по умолчанию открыта Основная группа ресурсов);
