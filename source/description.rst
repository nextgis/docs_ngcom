...
.. figure:: _static/webgis_flood_ru.png
   :name: webgis
   :align: center
   :width: 20cm
...
Посмотрите на платформу в действии в коротком видео:
...
Смотреть на `youtube <https://youtu.be/GzReGU2oACI>`_, `rutube <https://rutube.ru/video/9323ef11a606d852933f080c48e9ed1d/>`_.
