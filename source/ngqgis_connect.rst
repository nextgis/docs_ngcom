...
Загрузка данных из NextGIS QGIS в Веб ГИС
------------------------------------------------

Модуль NextGIS Connect позволяет быстро загружать в Веб ГИС растровые и векторные данные, а также целиком проекты QGIS.
...
* Выберите в панели слоев QGIS векторный слой (:term:`ESRI Shape` или :term:`GeoJSON`), который вы хотите загрузить в Веб ГИС;
...
* Выберите в панели слоев QGIS растровый слой (:term:`GeoTIFF`), который вы хотите загрузить в Веб ГИС;
* Нажмите кнопку :guilabel:`Импортировать выбранный слой` на панели инструментов модуля или выберите :menuselection:`NextGIS Connect --> Импортировать выбранный слой` в контекстном меню слоя;
...
Создание Сервисов WFS в Веб ГИС с помощью NextGIS Connect
--------------------------------------------------------------
...
Редактирование данных в Веб ГИС с помощью NextGIS Connect
---------------------------------------------------------------
...
Экспорт данных из Веб ГИС с помощью NextGIS Connect
--------------------------------------------------------

Модуль NextGIS Connect позволяет быстро экспортировать векторные данные из Веб ГИС в NextGIS QGIS. 
...
Создание Групп ресурсов в Веб ГИС с помощью NextGIS Connect
-------------------------------------------------------------------
...
Удаление ресурсов из Веб ГИС с помощью NextGIS Connect
--------------------------------------------------------
