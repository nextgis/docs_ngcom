...
* Нажмите кнопку **Добавить в Веб ГИС** на панели инструментов модуля или выберите **NextGIS Connect --> Загрузить выбранное** в контекстном меню слоя;
...
* Нажмите кнопку **Загрузить всё** на панели инструментов модуля или выберите **NextGIS Connect --> Импортировать текущий проект** в контекстном меню любого слоя;
