...
Чтобы дать возможность **нескольким пользователям** редактировать слой одновременно, включите `версионирование <https://docs.nextgis.ru/docs_ngweb/source/layers.html#create-vector-layer-vers-pic>`_ в настройках слоя или подключите слой `через WFS <https://docs.nextgis.ru/docs_ngcom/source/ngqgis_connect.html#ngcom-connect-data-edit-wfs>`_. Синхронизируются и версионируются только сами данные. Изменение структуры данных сделает синхронизацию невозможной и слой нужно будет скачать заново.
