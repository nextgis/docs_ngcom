...
Если вы забыли пароль от локального пользователя, то для его сброса администратор Веб ГИС должен выполнить следуюищие действия:

1. Войдите в Веб ГИС под пользователем с правами администратора. 
...
Как правило, стандартному пользователю платформы NextGIS достаточно глобального аккаунта. 
...
В отдельной Веб ГИС может быть включена **своя система** учетных записей, действующая **локально** в рамках этой Веб ГИС. Пользователи с такими учётными записями имеют доступ только к самой Веб ГИС, но не к остальному функционалу платформы.
