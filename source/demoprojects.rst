...
Для того, чтобы получить доступ к демо-проектам, вам нужно зайти на главную страницу своей Веб ГИС и авторизоваться в учетной записи пользователя **с правами администратора**. Перейти на страницу демо-проектов можно двумя способами:
