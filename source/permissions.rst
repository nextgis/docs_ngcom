...
.. note::
    Описываемая в данном разделе функциональность доступна в Веб ГИС, находящейся на тарифном плане `Премиум <https://nextgis.ru/pricing-base/>`_ или развёрнута `на своём сервере <http://nextgis.ru/pricing/>`_.
