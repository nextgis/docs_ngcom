...
#. The :guilabel:`Settings` tab is used to allow layer editing and enable annotations, set Web Map :term:`extent` and a title if it needs to be different than resource name.
