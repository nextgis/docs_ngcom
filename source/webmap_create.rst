...
#. Перейдите на вкладку :guilabel:`Описание`, вставьте URL изображения легенды и при необходимости допишите произвольный текст;
#. Нажмите кнопку :guilabel:`Сохранить`;
#. Откройте веб-карту. В левой части рабочей области находится панель **Описание** (иконка *информации*). При правильной настройке там будет находиться встроенная легенда карты.
