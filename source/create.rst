...
После авторизации в Веб ГИС через аккаунт на my.nextgis.com пользователь из `команды <https://docs.nextgis.ru/docs_ngcom/source/create.html#ngcom-team-management>`_ становится `пользователем Веб ГИС <https://docs.nextgis.ru/docs_ngweb/source/admin_tasks.html#id5>`_ и учитывается в лимите на их количество.
