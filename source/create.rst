...
После авторизации в Веб ГИС через аккаунт на my.nextgis.com пользователь из `команды <https://docs.nextgis.ru/docs_ngid/source/ngidop.html#ngidop-teams>`_ становится пользователем Веб ГИС и учитывается в лимите на их количество.
