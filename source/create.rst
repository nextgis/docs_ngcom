...
На следующем шаге необходимо придумать пароль и подтвердить согласие с `Пользовательским соглашением <http://nextgis.ru/terms>`_ и `Политикой конфиденциальности NextGIS <http://nextgis.ru/privacy>`_, а затем нажать на кнопку **Создать аккаунт** (см. :numref:`signup_form_pic`).
...
.. warning::
   ...
   Для аккаунтов с неподтвержденным адресом электронной почты создание Веб ГИС и использование сервисов NextGIS недоступно.
