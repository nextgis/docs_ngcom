...
.. note::
    В облаке количество доступных трекеров зависит от текущего `тарифного плана <https://nextgis.ru/pricing-base/>`_. На планах **Free** и **‘Mini’** - 1 трекер, на плане **‘Premium’** - 5 трекеров.

    Для Веб ГИС, развёрнутых на своём сервере, модуль для трекинга доступен в NextGIS Web `Extended <https://nextgis.ru/pricing/#ngwextended>`_ и `Enterprise <https://nextgis.ru/pricing/#ngwenterprise>`_.
