...
.. note::
    Количество доступных трекеров зависит от текущего тарифного плана. На плане ‘Mini’- 1 трекер, на плане ‘Premium’- 5 трекеров.
...
на сервер Веб ГИС и отображение записанных треков на веб карте, если произведены соответствующие настройки (ссылка).
