...
* Go to Control Panel -> Settings -> `Resource export <https://docs.nextgis.com/docs_ngweb/source/webmap_set.html#resource-export>`_
...
.. note:: 
   ...
   with the set `permissions <https://docs.nextgis.com/docs_ngweb/source/permissions.html>`_ to them.
