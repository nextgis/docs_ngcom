...
10. На вкладке `Стиль QGIS <https://docs.nextgis.ru/docs_ngweb/source/mapstyles.html#upload-svg-qgis-style>`__ выбрать созданную ранее библиотеку маркеров. Нажать **Создать**.
