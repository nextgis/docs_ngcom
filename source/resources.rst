...
* `OGC API Features <https://docs.nextgis.com/docs_ngweb/source/services.html#ngw-ogc-api-features>`_ (Third party software can use these services to edit vector data on server).
